...
d:connect(prefix.."FRI.JointPosition", "MotionManager.FRIRealJointPosLA", rtt.Variable("ConnPolicy"))
d:connect("MotionManager.DesiredJointPosLA", prefix.."Filter.DesiredJointPos", rtt.Variable("ConnPolicy"))
d:connect(prefix.."Filter.Log", "LogLA.Log", rtt.Variable("ConnPolicy"))
