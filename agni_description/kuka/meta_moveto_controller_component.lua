...
function moveto_controller_deploy(d, namespace, meta_component_name, meta_component_file, lowlevelctrl_name)  -- ##CHANGE ME##\
...
function moveto_controller_undeploy(d, namespace, meta_component_name)  -- ##CHANGE AT LEAST THE function NAME##
  -- access the mc
  name = namespace..meta_component_name
  if hasPeer(d, name) then
    mc = d:getPeer(name)
