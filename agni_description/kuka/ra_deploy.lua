...
d:import("/homes/skim/devel/rosbuild_ws_orocos/sOroComponent/SKukaMotionTest/lib/orocos/gnulinux/libSKukaMotionTest-gnulinux.so")
...
d:setActivity("LWRDiag", 0.02, 2, rtt.globals.ORO_SCHED_RT)
LWRDiag = d:getPeer("LWRDiag")
LWRDiag:configure()

d:loadComponent("FRI", "FRIComponent")
d:setActivity("FRI", 0.001, 0, rtt.globals.ORO_SCHED_RT)
FRI = d:getPeer("FRI")
FRI:getProperty("fri_port"):set(49940)
FRI:configure()


d:loadComponent("JointMotionGen", "SKukaMotionTest")
d:setActivity("JointMotionGen", 0.001, 1, rtt.globals.ORO_SCHED_RT)
...
d:setActivity("JntPub", 0.01, 3, rtt.globals.ORO_SCHED_RT)
